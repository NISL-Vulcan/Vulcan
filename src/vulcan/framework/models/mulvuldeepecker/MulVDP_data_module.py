...
class MulVDPDataLoader:
    ...
    def create_dataloader(self, path: str, seq_len: int, shuffle: bool, batch_size: int, n_workers: int) -> DataLoader:
    ...
    def transfer_batch_to_device(self, batch: MulVDPBatch, device: torch.device) -> MulVDPBatch:
