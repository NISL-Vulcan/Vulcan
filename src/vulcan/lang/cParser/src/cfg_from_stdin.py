...
from src.cfg_extractor.data_dependency_visitor import DataDependencyVisitor
...
def extract(stream):
    ...
    #cfg_extractor = DataDependencyVisitor()
    cfg_extractor.visit(parse_tree)
    #cfg_extractor.draw_data_dependency_graph()
